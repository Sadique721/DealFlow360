...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:22d3ee,100:8b5cf6&height=220&section=header&text=DealFlow360&fontSize=70&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Enterprise%20Autonomous%20Sales%20Operations%20%26%20CPQ%20Governance%20Platform&descAlignY=58&descAlign=50">
</p>

<!-- ========== TYPING SVG ANIMATION ========== -->
<p align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=3000&pause=1000&color=22D3EE&center=true&vCenter=true&width=750&lines=Autonomous+Multi-Tier+CPQ+Governance;Dynamic+Day-Based+Subscription+Proration+Engine;Z-Score+Anomaly+Detection+%26+SLA+Auto-Escalation;Least-Cost+Haversine+Multi-Warehouse+Split+Optimizer;Zero-Trust+Customer+Portal+with+Strict+COGS+Stripping;Engineered+for+Odoo+Combat+Enterprise+Hackathon" alt="Typing SVG" /></a>
</p>

<!-- ========== ENTERPRISE SHIELDS & BADGES ========== -->
<p align="center">
  <img src="https://img.shields.io/badge/Platform-DealFlow360-06B6D4?style=for-the-badge&logo=apache&logoColor=white" alt="Platform" />
...
```mermaid
pie title DealFlow360 Test Spectrum Distribution (100% Pass)
    "White-Box Edge Case" : 5
    "Black-Box Boundary Value" : 4
    "Grey-Box State Machine" : 1
    "Non-Functional Concurrency" : 2
    "Smoke & Sanity" : 1
    "User Acceptance (UAT)" : 3
    "Security & Zero-COGS" : 2
    "Cloud DB Integration" : 1
    "Domain & Workflow Engines" : 13
```
...
sequenceDiagram
    ...
    DB-->>Gateway: Raw Quotation Entity (contains COGS & Margins)
    Gateway->>DTO: Deep Strip Internal Fields
    Note over DTO: Redacts COGS, Unit Costs, Margin %, Culprit Metrics
    DTO-->>Customer: Safe Negotiation View (Public Pricing Only)
    Customer->>Gateway: Submit Counter-Offer ($180/unit)
    Gateway->>DB: Auto-Lock Quote -> Transition to LEVEL_1 Approval
    Gateway-->>Customer: Confirmation Badge: "Under Management Review"
```
...
<a href="https://www.instagram.com/mdsadiqueamin721/"><img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"></a>
